                    ...
                    <div className="flex flex-wrap justify-between w-full">
                        ...
                        >
                            <ItemContent className="mt-22">
                                <ItemTitle
                                    className="inline text-[34px] max-w-130 font-bold text-(--white-cl) [&>strong]:text-(--icon-cl)"
                                >
                                    <Trans i18nKey={"hero.title"}>
                                        Bargest is a <strong>web designer</strong> and <strong>front-end developer</strong>
                                    </Trans>
                                </ItemTitle>
                                <ItemDescription
                                    className="mt-6 text-[16px] max-w-140 text-(--text-cl)"
                                >
                                    {t("hero.description")}
                                </ItemDescription>
                        ...
                        >
                            <Item className="flex justify-end p-0 w-[78%]">
                                ...
                                <img src={geomFrom} alt="" className="absolute left-[18%] top-12 w-[24%]" />
                                <LiquidGlassCard
                                    className="
                        ...
                        <Item className="block min-w-full">
                            <ItemContent className="w-full flex flex-row justify-between items-center">
                                ...
                                <p className="flex items-center max-w-[10%] w-auto border-none">
                                    <Link to="" className="text-[16px] text-(--white-cl) font-medium">
                                        <Trans i18nKey={"projects.viewAll"}>
                                            View all
                                        </Trans>
                                    </Link>
                    ...
                    <Item className="block min-w-full">
                        ...
                        <ItemContent className="mt-11 flex flex-row justify-between min-w-full w-full">
                            ...
                            <motion.div
                                ...
                                >
                                    <TypingAnimation className="text-(--white-cl)">&gt; system_check --list-skills</TypingAnimation>
                                    ...
                                    <TypingAnimation delay={500} className="text-muted-foreground text-(--white-cl)">
                                      &gt; execute: make_coffee --double-espresso
                                    </TypingAnimation>
                                    <TypingAnimation delay={1500} className="text-muted-foreground text-(--white-cl)">
                                      [process] Brewing... ████████░░ 80%
                                    </TypingAnimation>
                        ...
                        <Item className="block min-w-full">
                            ...
                            <ItemContent className="flex flex-row justify-between w-full items-center min-h-[50vh]">
                                <motion.div
                                    ...
                                    <Link to="/aboutMe" target="_blank" className="inline-block">
                                ...
                                <div className="flex flex-col justify-center items-center relative w-1/2 shrink-0">
                                    ...
                                    <img src={matrix} alt="" className="absolute w-20 top-9 left-40" />
                                    <img src={matrixLong} alt="" className="absolute top-[55%] right-28" />
