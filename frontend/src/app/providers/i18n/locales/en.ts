export default {
    translation: {
        ...
        projects: {
            ...
            items: {
                infostorm: {
                  description: "Automated news aggregator with XML parsing and background updates for a focused, ad-free reading experience.",
                },
                weather: {
                  description: "High-precision weather tracking system delivering real-time atmospheric metrics and environmental data.",
                },
                necoChat: {
                  description: "Advanced communication platform featuring secure JWT-auth and complex state management for real-time messaging.",
                },
            }
        },
        skills: {
        ...
        contacts: {
            title: "#<1>contacts</1>",
            text: "Let’s work together! I’m always open to new opportunities, custom projects, and creative collaborations. \n" + "Let’s make something great together!",
